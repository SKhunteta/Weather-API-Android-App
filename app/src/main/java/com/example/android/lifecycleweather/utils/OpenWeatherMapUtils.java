...
public class OpenWeatherMapUtils {
    ...
    private final static String OWM_UNIT_FORMAT_STRING = "units=%s";
    private final static String OWM_LOCATION_FORMAT_STRING = "q=%s";

    /*
     * Set your own APPID here.
     */
    private final static String OWM_FORECAST_APPID = "c222abf341097a235fa1772574475ffc";
    ...
    public static String buildForecastURL(String location, String unit) {

            return Uri.parse(OWM_FORECAST_BASE_URL).buildUpon()
                    .appendQueryParameter(OWM_FORECAST_QUERY_PARAM, location)
                    .appendQueryParameter(OWM_FORECAST_UNITS_PARAM, unit)
